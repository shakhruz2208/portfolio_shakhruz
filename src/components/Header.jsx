...
const Header = () => {
  ...
  return (
    <div   className={scrolled ? 'header z-30 w-full h-20 bg-[#e0e0e0] flex items-center transition-all ease-in-out duration-500  fixed' : ' header z-30 w-full h-20 transition-all ease-initial duration-1000 bg-transparent flex items-center  fixed'}>
      <div className=' pl-14 flex items-center gap-130'>
        <div>
            <img className='w-55' src={logo}/>
        </div>
        <div className={scrolled ? 'flex gap-7 text-xl items-center text-black' : 'flex gap-7 text-xl items-center text-white'}>
